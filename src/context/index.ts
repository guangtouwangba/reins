...
export function generateContext(
  ...
  if (includeL1) {
    // L1 directory profiles are built but AGENTS.md files are NOT written to subdirectories.
    // The root AGENTS.md is generated by the claude-code adapter instead.
    // Per-directory AGENTS.md can be re-enabled when needed.
